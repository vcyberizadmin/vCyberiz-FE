...
class FooterServices extends DioBaseService {
  final Dio _dio = DioBaseService.dio;
  Future<Response<dynamic>?> getFooterDataApi() async {
    try {
      return await _dio.get(
        ApiConst.footerEndPoint,
      );
  ...
  Future<Response<dynamic>?> getSubscribeApi(
    String email,
  ) async {
    try {
      Object body = {
